// Command TruthOrDare-cli is a CLI + REPL for the TruthOrDare SDK,
...
const entitiesHelp = "dare nhie paranoia truth wyr"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      TRUTH_OR_DARE_APIKEY (api key), TRUTH_OR_DARE_BASE (base url override)")
