...
func registerSDKWords(r *eng.Registry, client *sdk.TruthOrDareSDK) {
...
func runOp(client *sdk.TruthOrDareSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
