...
#      offline in seeded test mode (TruthOrDareSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TruthOrDare_sdk.rb")
  SDK_CLASS = "TruthOrDareSDK"
