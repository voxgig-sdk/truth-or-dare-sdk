...
The Ruby SDK for the TruthOrDare API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `TruthOrDareError` (a `StandardError` subclass), so wrap
