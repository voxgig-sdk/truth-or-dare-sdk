...
class TruthEntity
  ...
  # @return [Truth, Hash] the current Truth data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Truth fields)
  def match_get
  ...
  # Load a single Truth.
  #
  # @param reqmatch [TruthLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Truth.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Truth, Hash] the loaded Truth; raises TruthOrDareError on failure
