...
class NhieDirectTest extends TestCase
{
    public function test_direct_load_nhie(): void
    {
        $setup = nhie_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-nhie", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
