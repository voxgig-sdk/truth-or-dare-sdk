...
class ParanoiaDirectTest extends TestCase
{
    public function test_direct_load_paranoia(): void
    {
        $setup = paranoia_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-paranoia", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
