...
// TruthOrDare SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TruthOrDareSDK::test)
...
{
    private const SDK_CLASS = 'TruthOrDareSDK';
    ...
    private const SDK_BASE = 'truthordare_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../truthordare_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
