...
class TruthOrDareTestRunner
{
    ...
    {
        $live = self::getenv('TRUTH_OR_DARE_TEST_LIVE');
        $override = self::getenv('TRUTH_OR_DARE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TRUTH_OR_DARE_TEST_EXPLAIN');
...
class_alias('TruthOrDareTestRunner', 'Runner');
class_alias('TruthOrDareHelpers', 'Helpers');
