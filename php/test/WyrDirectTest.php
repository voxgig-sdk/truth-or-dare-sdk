...
class WyrDirectTest extends TestCase
{
    public function test_direct_load_wyr(): void
    {
        $setup = wyr_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-wyr", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
