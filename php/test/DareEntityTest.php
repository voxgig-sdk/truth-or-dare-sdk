...
class DareEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TRUTH_OR_DARE_TEST_DARE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $dare_ref01_data_dt0_load_result = Helpers::to_map(is_object($dare_ref01_data_dt0_loaded) && method_exists($dare_ref01_data_dt0_loaded, 'data_get') ? $dare_ref01_data_dt0_loaded->data_get() : $dare_ref01_data_dt0_loaded);
...
function dare_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TRUTH_OR_DARE_TEST_DARE_ENTID");
