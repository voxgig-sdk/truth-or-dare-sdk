...
class TruthDirectTest extends TestCase
{
    public function test_direct_load_truth(): void
    {
        $setup = truth_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-truth", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
