...
The PHP SDK for the TruthOrDare API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Dare(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->TruthOrDare(null)->load(
    ["id" => "test01"], null
);
