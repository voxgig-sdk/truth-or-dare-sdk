...
// TruthOrDare SDK netsim feature
...
class TruthOrDareNetsimFeature extends TruthOrDareBaseFeature
{
    ...
    private function _simulate(TruthOrDareContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TruthOrDareContext $ctx, array $applied): void
    {
        $client = $this->client;
