...
// TruthOrDare SDK metrics feature
...
class TruthOrDareMetricsFeature extends TruthOrDareBaseFeature
{
    ...
    private function _record(TruthOrDareContext $ctx, bool $ok): void
    {
