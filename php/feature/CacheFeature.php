...
class TruthOrDareCacheFeature extends TruthOrDareBaseFeature
{
    ...
    private function _through(TruthOrDareContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
