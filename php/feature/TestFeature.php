...
// TruthOrDare SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TruthOrDareTestFeature extends TruthOrDareBaseFeature
{
    ...
    public function init(TruthOrDareContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TruthOrDareContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = TruthOrDareParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TruthOrDareContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TruthOrDareContext $ctx, $op, $args): array
    {
