...
// TruthOrDare SDK timeout feature
...
class TruthOrDareTimeoutFeature extends TruthOrDareBaseFeature
{
    ...
    private function _with_timeout(TruthOrDareContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TruthOrDareContext $_ctx, float $ms): void
    {
        $client = $this->client;
