...
class TruthOrDareRbacFeature extends TruthOrDareBaseFeature
{
    ...
    private function _required(TruthOrDareContext $ctx): ?string
    {
    ...
    private function _reject(TruthOrDareContext $ctx, string $required): void
    {
    ...
    private function _track(TruthOrDareContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
