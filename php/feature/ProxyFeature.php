...
class TruthOrDareProxyFeature extends TruthOrDareBaseFeature
{
    ...
    public function init(TruthOrDareContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TruthOrDareContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
