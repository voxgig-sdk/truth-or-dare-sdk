...
// TruthOrDare SDK utility: graphql
//
...
class TruthOrDareGraphql
{
    ...
    // equivalent.
    public static function body(TruthOrDareContext $ctx): mixed
    {
    ...
    public static function errors(TruthOrDareContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
