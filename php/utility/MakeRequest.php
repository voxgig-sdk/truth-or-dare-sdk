...
// TruthOrDare SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TruthOrDareMakeRequest
{
    public static function call(TruthOrDareContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TruthOrDareResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TruthOrDareResponse($fetched);
        } else {
