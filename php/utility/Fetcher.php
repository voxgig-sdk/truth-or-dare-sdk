...
// TruthOrDare SDK utility: fetcher

class TruthOrDareFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TruthOrDareSDK/1.0)';
    ...
    public static function call(TruthOrDareContext $ctx, string $fullurl, array $fetchdef): array
    {
