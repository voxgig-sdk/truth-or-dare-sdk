...
class TruthEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TruthEntity($this->_client, $opts);
    }

    /**
     * @param Truth|array $args Truth data (assoc-array) to store.
     */
    ...
    /**
     * @return Truth|array The current Truth data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Truth fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Truth fields).
     */
     ...
     * Load a single Truth.
     *
     * @param TruthLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TruthLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Truth|array The loaded Truth as an assoc-array at the
