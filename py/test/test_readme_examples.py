# TruthOrDare SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TruthOrDareSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TruthOrDareSDK(...) and TruthOrDareSDK.test(...) become
#      TruthOrDareSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "truthordare_sdk"
_SDK_CLASS = "TruthOrDareSDK"
