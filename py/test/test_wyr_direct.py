...
class TestWyrDirect:
    ...
    def test_should_direct_load_wyr(self):
        setup = _wyr_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-wyr", "live" if setup["live"] else "unit")
        if _skip:
