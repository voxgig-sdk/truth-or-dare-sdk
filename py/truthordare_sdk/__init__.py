...
from truthordare_sdk.utility import register

# Load features
from truthordare_sdk.feature.base_feature import TruthOrDareBaseFeature
from truthordare_sdk.features import _has_feature, _make_feature
...
class TruthOrDareSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TruthOrDareUtility()
        self._utility = utility

        from truthordare_sdk.config import shared_config
    ...
    def get_utility(self):
        return TruthOrDareUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "TruthOrDareSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TruthOrDareSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Dare(self, data=None) -> "DareEntity":
        ...
        from truthordare_sdk.entity.dare_entity import DareEntity
        return DareEntity(self, data)


    def Nhie(self, data=None) -> "NhieEntity":
        """Entity factory: client.Nhie().list() / client.Nhie().load({"id": ...})."""
        from truthordare_sdk.entity.nhie_entity import NhieEntity
