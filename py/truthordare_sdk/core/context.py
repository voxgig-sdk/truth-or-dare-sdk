...
from truthordare_sdk.core.control import TruthOrDareControl
...
from truthordare_sdk.core.helpers import get_ctx_prop, to_map
...
class TruthOrDareContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, TruthOrDareSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TruthOrDareResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TruthOrDareResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TruthOrDareError(code, msg, self)
