# TruthOrDare Python SDK



The Python SDK for the TruthOrDare API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Dare()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/truth-or-dare-sdk/releases)) or
...
```
py/
├── truthordare_sdk.py         -- Main SDK module
...
The main module (`truthordare_sdk`) exports the SDK class.
