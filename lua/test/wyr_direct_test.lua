...
describe("WyrDirect", function()
  it("should direct-load-wyr", function()
    local setup = wyr_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-wyr", setup.live and "live" or "unit")
...
function wyr_direct_setup(mockres)
