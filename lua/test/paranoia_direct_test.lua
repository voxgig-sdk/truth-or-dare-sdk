...
describe("ParanoiaDirect", function()
  it("should direct-load-paranoia", function()
    local setup = paranoia_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-paranoia", setup.live and "live" or "unit")
...
function paranoia_direct_setup(mockres)
