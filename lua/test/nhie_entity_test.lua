...
describe("NhieEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TRUTH_OR_DARE_TEST_NHIE_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    local nhie_ref01_data_dt0_load_result = helpers.to_map(type(nhie_ref01_data_dt0_loaded) == 'table' and nhie_ref01_data_dt0_loaded.data_get and nhie_ref01_data_dt0_loaded:data_get() or nhie_ref01_data_dt0_loaded)
...
function nhie_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TRUTH_OR_DARE_TEST_NHIE_ENTID")
