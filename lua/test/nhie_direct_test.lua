...
describe("NhieDirect", function()
  it("should direct-load-nhie", function()
    local setup = nhie_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-nhie", setup.live and "live" or "unit")
...
function nhie_direct_setup(mockres)
