...
local SDK_MODULE = "truth-or-dare_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["dare"] = { ["test01"] = { id = "test01" } }, ["nhie"] = { ["test01"] = { id = "test01" } }, ["paranoia"] = { ["test01"] = { id = "test01" } }, ["truth"] = { ["test01"] = { id = "test01" } }, ["wyr"] = { ["test01"] = { id = "test01" } } } }'
