...
describe("TruthDirect", function()
  it("should direct-load-truth", function()
    local setup = truth_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-truth", setup.live and "live" or "unit")
...
function truth_direct_setup(mockres)
