...
function runner.env_override(m)
  local live = runner.getenv("TRUTHORDARE_TEST_LIVE")
  local override = runner.getenv("TRUTHORDARE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TRUTHORDARE_TEST_EXPLAIN")
