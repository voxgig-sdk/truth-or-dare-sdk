...
function runner.env_override(m)
  local live = runner.getenv("TRUTH_OR_DARE_TEST_LIVE")
  local override = runner.getenv("TRUTH_OR_DARE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TRUTH_OR_DARE_TEST_EXPLAIN")
