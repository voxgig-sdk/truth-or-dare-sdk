...
// TruthOrDare SDK ratelimit feature
...
class TruthOrDareRatelimitFeature extends TruthOrDareBaseFeature
{
    ...
    private function _acquire(TruthOrDareContext $ctx): void
    {
    ...
    private function _track(TruthOrDareContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
