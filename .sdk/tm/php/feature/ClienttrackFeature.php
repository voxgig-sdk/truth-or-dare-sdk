...
// TruthOrDare SDK clienttrack feature
...
class TruthOrDareClienttrackFeature extends TruthOrDareBaseFeature
{
    ...
    public function PostConstruct(TruthOrDareContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TruthOrDare-SDK';
