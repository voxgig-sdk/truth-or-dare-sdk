...
// TruthOrDare SDK streaming feature
...
class TruthOrDareStreamingFeature extends TruthOrDareBaseFeature
{
    ...
    private function _iterate(TruthOrDareResult $result): \Generator
    {
    ...
    private function _streamable(TruthOrDareContext $ctx): bool
    {
