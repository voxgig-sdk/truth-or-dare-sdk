...
// TruthOrDare SDK telemetry feature
...
class TruthOrDareTelemetryFeature extends TruthOrDareBaseFeature
{
    ...
    private function _close(TruthOrDareContext $ctx, bool $ok): void
    {
