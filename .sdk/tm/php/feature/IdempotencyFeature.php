...
// TruthOrDare SDK idempotency feature
...
class TruthOrDareIdempotencyFeature extends TruthOrDareBaseFeature
{
    ...
    private function _mutating(TruthOrDareContext $ctx): bool
    {
