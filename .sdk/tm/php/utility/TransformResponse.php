...
// TruthOrDare SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class TruthOrDareTransformResponse
{
    public static function call(TruthOrDareContext $ctx): mixed
    {
        ...
        $transform = TruthOrDareHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
