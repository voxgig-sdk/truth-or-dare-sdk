...
class TruthOrDareTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TruthOrDareTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TruthOrDareTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TruthOrDareTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
