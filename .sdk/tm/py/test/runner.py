...
class TruthOrDareTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TruthOrDareTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = TruthOrDareTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = TruthOrDareTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
