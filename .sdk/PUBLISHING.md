...
|---|---|---|
| `ts/` | @voxgig-sdk/truth-or-dare-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/truth-or-dare-sdk \
      --repository voxgig-sdk/truth-or-dare-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/truth-or-dare-sdk` shows it, and
`npm trust revoke @voxgig-sdk/truth-or-dare-sdk --id=<id>` removes it.
