...
func (sdk *TruthOrDareSDK) OptionsMap() map[string]any {
...
func (sdk *TruthOrDareSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TruthOrDareSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TruthOrDareSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TruthOrDareSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TruthOrDareSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TruthOrDareSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TruthOrDareSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TruthOrDareSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TruthOrDareSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TruthOrDareSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
