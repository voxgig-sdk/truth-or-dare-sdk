# TruthOrDare Golang SDK Reference

Complete API reference for the TruthOrDare Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *TruthOrDareSDK`
