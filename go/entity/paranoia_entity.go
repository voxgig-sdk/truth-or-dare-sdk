...
func NewParanoiaEntity(client *core.TruthOrDareSDK, entopts map[string]any) *ParanoiaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ParanoiaEntity) GetName() string { return e.name }
...
func (e *ParanoiaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ParanoiaEntity) Deleted() bool {
	return e.deleted
}


func (e *ParanoiaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewParanoiaEntity(e.client, opts)
}

func (e *ParanoiaEntity) Data(args ...any) any {
...
func (e *ParanoiaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Paranoia; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ParanoiaEntity) DataTyped(data ...Paranoia) Paranoia {
	if len(data) > 0 {
		return typedFrom[Paranoia](e.Data(asMap(data[0])))
	}
	return typedFrom[Paranoia](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Paranoia (all fields
// optional at the wire level).
func (e *ParanoiaEntity) MatchTyped(match ...Paranoia) Paranoia {
	if len(match) > 0 {
		return typedFrom[Paranoia](e.Match(asMap(match[0])))
	}
	return typedFrom[Paranoia](e.Match())
}
...
func (e *ParanoiaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ParanoiaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ParanoiaLoadMatch and returns an Paranoia. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ParanoiaEntity) LoadTyped(reqmatch ParanoiaLoadMatch, ctrl map[string]any) (Paranoia, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Paranoia{}, err
	}
	return typedFrom[Paranoia](res), nil
}



func (e *ParanoiaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ParanoiaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ParanoiaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ParanoiaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ParanoiaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
