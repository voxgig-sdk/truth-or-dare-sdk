...
func NewWyrEntity(client *core.TruthOrDareSDK, entopts map[string]any) *WyrEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WyrEntity) GetName() string { return e.name }
...
func (e *WyrEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WyrEntity) Deleted() bool {
	return e.deleted
}


func (e *WyrEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWyrEntity(e.client, opts)
}

func (e *WyrEntity) Data(args ...any) any {
...
func (e *WyrEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Wyr; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WyrEntity) DataTyped(data ...Wyr) Wyr {
	if len(data) > 0 {
		return typedFrom[Wyr](e.Data(asMap(data[0])))
	}
	return typedFrom[Wyr](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Wyr (all fields
// optional at the wire level).
func (e *WyrEntity) MatchTyped(match ...Wyr) Wyr {
	if len(match) > 0 {
		return typedFrom[Wyr](e.Match(asMap(match[0])))
	}
	return typedFrom[Wyr](e.Match())
}
...
func (e *WyrEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WyrEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WyrLoadMatch and returns an Wyr. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WyrEntity) LoadTyped(reqmatch WyrLoadMatch, ctrl map[string]any) (Wyr, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Wyr{}, err
	}
	return typedFrom[Wyr](res), nil
}



func (e *WyrEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WyrEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WyrEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WyrEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WyrEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
