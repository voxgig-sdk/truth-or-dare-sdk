...
func NewTruthEntity(client *core.TruthOrDareSDK, entopts map[string]any) *TruthEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TruthEntity) GetName() string { return e.name }
...
func (e *TruthEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TruthEntity) Deleted() bool {
	return e.deleted
}


func (e *TruthEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTruthEntity(e.client, opts)
}

func (e *TruthEntity) Data(args ...any) any {
...
func (e *TruthEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Truth; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TruthEntity) DataTyped(data ...Truth) Truth {
	if len(data) > 0 {
		return typedFrom[Truth](e.Data(asMap(data[0])))
	}
	return typedFrom[Truth](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Truth (all fields
// optional at the wire level).
func (e *TruthEntity) MatchTyped(match ...Truth) Truth {
	if len(match) > 0 {
		return typedFrom[Truth](e.Match(asMap(match[0])))
	}
	return typedFrom[Truth](e.Match())
}
...
func (e *TruthEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TruthEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TruthLoadMatch and returns an Truth. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TruthEntity) LoadTyped(reqmatch TruthLoadMatch, ctrl map[string]any) (Truth, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Truth{}, err
	}
	return typedFrom[Truth](res), nil
}



func (e *TruthEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TruthEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TruthEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TruthEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TruthEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
