...
func NewNhieEntity(client *core.TruthOrDareSDK, entopts map[string]any) *NhieEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NhieEntity) GetName() string { return e.name }
...
func (e *NhieEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NhieEntity) Deleted() bool {
	return e.deleted
}


func (e *NhieEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNhieEntity(e.client, opts)
}

func (e *NhieEntity) Data(args ...any) any {
...
func (e *NhieEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Nhie; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NhieEntity) DataTyped(data ...Nhie) Nhie {
	if len(data) > 0 {
		return typedFrom[Nhie](e.Data(asMap(data[0])))
	}
	return typedFrom[Nhie](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Nhie (all fields
// optional at the wire level).
func (e *NhieEntity) MatchTyped(match ...Nhie) Nhie {
	if len(match) > 0 {
		return typedFrom[Nhie](e.Match(asMap(match[0])))
	}
	return typedFrom[Nhie](e.Match())
}
...
func (e *NhieEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NhieEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NhieLoadMatch and returns an Nhie. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NhieEntity) LoadTyped(reqmatch NhieLoadMatch, ctrl map[string]any) (Nhie, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Nhie{}, err
	}
	return typedFrom[Nhie](res), nil
}



func (e *NhieEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NhieEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NhieEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NhieEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NhieEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
