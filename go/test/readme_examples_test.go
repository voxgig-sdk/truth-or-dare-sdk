...
const testSeed = `map[string]any{"entity": map[string]any{"dare": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "nhie": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "paranoia": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "truth": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "wyr": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
