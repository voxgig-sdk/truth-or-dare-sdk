...
describe('TruthDirect', async () => {
  ...
  test('direct-load-truth', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-truth', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['TRUTH_OR_DARE_TEST_TRUTH_ENTID']
