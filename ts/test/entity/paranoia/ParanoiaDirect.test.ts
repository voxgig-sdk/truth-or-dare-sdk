...
describe('ParanoiaDirect', async () => {
  ...
  test('direct-load-paranoia', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-paranoia', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['TRUTH_OR_DARE_TEST_PARANOIA_ENTID']
