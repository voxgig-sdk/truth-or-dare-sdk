...
describe('WyrDirect', async () => {
  ...
  test('direct-load-wyr', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-wyr', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['TRUTH_OR_DARE_TEST_WYR_ENTID']
