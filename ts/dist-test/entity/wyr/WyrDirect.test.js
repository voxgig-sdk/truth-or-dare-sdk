...
(0, node_test_1.describe)('WyrDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TruthOrDareSDK({
    ...
    (0, node_test_1.test)('direct-load-wyr', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-wyr', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TruthOrDareSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['TRUTH_OR_DARE_TEST_WYR_ENTID'];
    ...
    const client = new __1.TruthOrDareSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=WyrDirect.test.js.map