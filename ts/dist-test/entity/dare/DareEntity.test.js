...
(0, node_test_1.describe)('DareEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(dare_ref01_data_dt0.id === dare_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['TRUTH_OR_DARE_TEST_DARE_ENTID'];
    ...
    idmap = env['TRUTH_OR_DARE_TEST_DARE_ENTID'];
