...
(0, node_test_1.describe)('NhieEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'nhie.' + op, live))
                return;
        }
        ...
        let nhie_ref01_data = Object.values(setup.data.existing.nhie)[0];
        // LOAD
        const nhie_ref01_ent = client.Nhie();
        const nhie_ref01_match_dt0 = {};
        nhie_ref01_match_dt0.id = nhie_ref01_data.id;
        const nhie_ref01_data_dt0 = (await nhie_ref01_ent.load(nhie_ref01_match_dt0)).data();
        (0, node_assert_1.default)(nhie_ref01_data_dt0.id === nhie_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/nhie/NhieTestData.json');
    ...
    let idmap = transform(['nhie01', 'nhie02', 'nhie03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=NhieEntity.test.js.map