...
(0, node_test_1.describe)('NhieDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-nhie', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-nhie', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRUTH_OR_DARE_TEST_NHIE_ENTID'];
...
//# sourceMappingURL=NhieDirect.test.js.map