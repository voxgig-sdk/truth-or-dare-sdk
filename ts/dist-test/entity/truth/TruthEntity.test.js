...
(0, node_test_1.describe)('TruthEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'truth.' + op, live))
                return;
        }
        ...
        let truth_ref01_data = Object.values(setup.data.existing.truth)[0];
        // LOAD
        const truth_ref01_ent = client.Truth();
        const truth_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(truth_ref01_data_dt0.id === truth_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/truth/TruthTestData.json');
    ...
    let idmap = transform(['truth01', 'truth02', 'truth03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRUTH_OR_DARE_TEST_TRUTH_ENTID'];
...
//# sourceMappingURL=TruthEntity.test.js.map