...
(0, node_test_1.describe)('TruthDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-truth', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-truth', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRUTH_OR_DARE_TEST_TRUTH_ENTID'];
...
//# sourceMappingURL=TruthDirect.test.js.map