...
(0, node_test_1.describe)('ParanoiaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-paranoia', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-paranoia', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRUTH_OR_DARE_TEST_PARANOIA_ENTID'];
...
//# sourceMappingURL=ParanoiaDirect.test.js.map