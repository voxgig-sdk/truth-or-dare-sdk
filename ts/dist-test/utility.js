...
function envOverride(m) {
    if ('TRUE' === process.env.TRUTH_OR_DARE_TEST_LIVE ||
        'TRUE' === process.env.TRUTH_OR_DARE_TEST_OVERRIDE) {
    ...
    m.TRUTH_OR_DARE_TEST_EXPLAIN = process.env.TRUTH_OR_DARE_TEST_EXPLAIN || m.TRUTH_OR_DARE_TEST_EXPLAIN;
    return m;
}
